...
const AuthDoctor = ({ setUserType }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (isSignup) {
      // Sign Up
      localStorage.setItem("doctorName", form.name);
      localStorage.setItem("doctorEmail", form.email);
      localStorage.setItem("doctorPassword", form.password);
      ...
      if (form.email === storedEmail && form.password === storedPassword) {
        ...
        setUserType("doctor");
        navigate("/doctor-dashboard"); // Redirect to the doctor's dashboard
      } else {
